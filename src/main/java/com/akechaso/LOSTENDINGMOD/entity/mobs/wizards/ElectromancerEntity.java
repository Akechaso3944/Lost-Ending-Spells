...
public class ElectromancerEntity extends NeutralWizard implements IMerchantWizard {
    ...
    public ElectromancerEntity(EntityType<? extends AbstractSpellCastingMob> type, Level level) {
        super(type, level);
        this.xpReward = 25;
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new WizardAttackGoal(this, 1.25F, 25, 50)
                .setSpells(
                        // attack
                        List.of(SpellRegistry.BALL_LIGHTNING_SPELL.get(), SpellRegistry.CHARGE_SPELL.get(), SpellRegistry.LIGHTNING_LANCE_SPELL.get()),
                        // heal
                        List.of(SpellRegistry.HEAL_SPELL.get()),
                        List.of(SpellRegistry.ELECTROCUTE_SPELL.get()),
                        List.of()
                )
                .setDrinksPotions()
                .setSingleUseSpell(ModSpellRegistry.EYE_OF_STORM_SPELL.get(), 0, 0, 1, 1)
        );
